...
class CustomDataObjectService {
    ...
    async getAttributes(custom_object_id) {
        ...
        return await this.attributesRepository.getAll(custom_object_id);
    }
    ...
    async deleteAllAttributes(custom_data_object_id) {
        ...
        var attribute_ids = await this.attributesRepository.getAll(custom_data_object_id)
            .then(attrs => attrs.map(attr => attr.id));
        if (attribute_ids.length > 0) {
            await this.attributesRepository.deleteMany(custom_data_object_id, attribute_ids);
        }
    }
    ...
    async deleteAttributes(custom_data_object_id, attribute_names) {
        ...
        var filtered_attributes = await this.attributesRepository.getAll(custom_data_object_id)
